...
class Info(Extension):
    ...
    async def info(self, ctx : InteractionContext):
            ...
            """
            try : 
                embed = Embed(title="Informations du bot", color=Color.from_hex("#2596be"), timestamp=Timestamp.now())
                ...
                embed.add_field(name="Créé le", value=f"<t:1700768182:F>", inline=False)
                ...
                embed.thumbnail = self.bot.user.avatar_url
